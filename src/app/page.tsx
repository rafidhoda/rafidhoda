...
// Dark, calm, editorial playground page.
// Inline primitives only (no external UI libs).
...
const accent = "from-orange-400 to-orange-500"; // single accent palette (used sparingly)
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-10 space-y-10">
        ...
        <p className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-500/10 border border-orange-500/30 text-xs uppercase tracking-[0.25em] text-orange-200/80">
            ...
            <p className="text-lg text-zinc-300 leading-relaxed">
              This page is a playground: public content components, audio-first ideas, internal admin
              tooling, and future content-machine outputs. Everything is mock data, optimized for clarity and
              calm.
            </p>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-base text-zinc-300 leading-relaxed max-w-3xl">
                I build systems for people who sell, support, and ship software. This space is both a public
                brain and an internal workbench: ideas, reminders, guides, and the tooling to publish them
                everywhere without chaos.
              </p>
            </div>
              ...
              <Card title="Transcript" meta="Collapsible">
                <details className="rounded-lg border border-zinc-800 bg-zinc-900/70 p-3">
                  ...
                  <p className="mt-3 text-sm text-zinc-300 leading-relaxed">
                    Today I’m thinking about an operating system for content: voice-first, low friction, and
                    ready to publish everywhere. It should feel calm, serious, and executable.
                  </p>
                </details>
              </Card>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-lg border border-zinc-800 bg-zinc-900 text-sm text-zinc-300 p-3 leading-relaxed">
                Preview: “Ship audio before decks. Publish the transcript. Let the system syndicate to every
                channel. Calm, repeatable, boringly consistent.”
              </div>
            </div>
          </div>
        </Section>
